		...
		if($jenise == 1)
		{
			if($getTingkat == "X")
			{
				...
				{																	
					...
					$objPHPExcel->getActiveSheet()->setCellValue('I199', $this->mlaporan->getNamaAgama($dt_raport['agama']));
					$statuseeee = array('Anak Kandung','Anak Angkat');
					$objPHPExcel->getActiveSheet()->setCellValue('I200', $statuseeee[$dt_raport['status']]);
					...
					$objPHPExcel->getActiveSheet()->setCellValue('O303', $dt_raport['wali_k']['nama_w']);
					$objPHPExcel->getActiveSheet()->setCellValue('O304', "NIP. ".$dt_raport['wali_k']['nip_w']);
					$objPHPExcel->getActiveSheet()->setCellValue('O299', "Rembang, ".$tanggal);

					$objPHPExcel->getActiveSheet()->setCellValue('C252', $dt_raport['mapel']['0']['NamaMapel']);
					$objPHPExcel->getActiveSheet()->setCellValue('E253', $dt_raport['mapel']['0']['NGuruMapel']);
					$objPHPExcel->getActiveSheet()->setCellValue('K252', $dt_raport['mapel']['0']['detail']['pengetahuan']['konversi']);
					$objPHPExcel->getActiveSheet()->setCellValue('M252', $dt_raport['mapel']['0']['detail']['keterampilan']['konversi']);
					$objPHPExcel->getActiveSheet()->setCellValue('O252', $dt_raport['mapel']['0']['detail']['sikap']['konversi']);
					$objPHPExcel->getActiveSheet()->setCellValue('C254', $dt_raport['mapel']['1']['NamaMapel']);
					$objPHPExcel->getActiveSheet()->setCellValue('E255', $dt_raport['mapel']['1']['NGuruMapel']);
					$objPHPExcel->getActiveSheet()->setCellValue('K254', $dt_raport['mapel']['1']['detail']['pengetahuan']['konversi']);
					$objPHPExcel->getActiveSheet()->setCellValue('M254', $dt_raport['mapel']['1']['detail']['keterampilan']['konversi']);
					$objPHPExcel->getActiveSheet()->setCellValue('O254', $dt_raport['mapel']['1']['detail']['sikap']['konversi']);
					$objPHPExcel->getActiveSheet()->setCellValue('C256', $dt_raport['mapel']['2']['NamaMapel']);
					$objPHPExcel->getActiveSheet()->setCellValue('E257', $dt_raport['mapel']['2']['NGuruMapel']);
					$objPHPExcel->getActiveSheet()->setCellValue('K256', $dt_raport['mapel']['2']['detail']['pengetahuan']['konversi']);
					$objPHPExcel->getActiveSheet()->setCellValue('K256', $dt_raport['mapel']['2']['detail']['keterampilan']['konversi']);
					$objPHPExcel->getActiveSheet()->setCellValue('O256', $dt_raport['mapel']['2']['detail']['sikap']['konversi']);
					$objPHPExcel->getActiveSheet()->setCellValue('C258', $dt_raport['mapel']['3']['NamaMapel']);
					$objPHPExcel->getActiveSheet()->setCellValue('E269', $dt_raport['mapel']['3']['NGuruMapel']);
					$objPHPExcel->getActiveSheet()->setCellValue('K258', $dt_raport['mapel']['3']['detail']['pengetahuan']['konversi']);
					$objPHPExcel->getActiveSheet()->setCellValue('M258', $dt_raport['mapel']['3']['detail']['keterampilan']['konversi']);
					$objPHPExcel->getActiveSheet()->setCellValue('O258', $dt_raport['mapel']['3']['detail']['sikap']['konversi']);
					$objPHPExcel->getActiveSheet()->setCellValue('C260', $dt_raport['mapel']['4']['NamaMapel']);
					$objPHPExcel->getActiveSheet()->setCellValue('E261', $dt_raport['mapel']['4']['NGuruMapel']);
					$objPHPExcel->getActiveSheet()->setCellValue('K260', $dt_raport['mapel']['4']['detail']['pengetahuan']['konversi']);
					$objPHPExcel->getActiveSheet()->setCellValue('M260', $dt_raport['mapel']['4']['detail']['keterampilan']['konversi']);
					$objPHPExcel->getActiveSheet()->setCellValue('O260', $dt_raport['mapel']['4']['detail']['sikap']['konversi']);
					$objPHPExcel->getActiveSheet()->setCellValue('C262', $dt_raport['mapel']['5']['NamaMapel']);
					$objPHPExcel->getActiveSheet()->setCellValue('E263', $dt_raport['mapel']['5']['NGuruMapel']);
					$objPHPExcel->getActiveSheet()->setCellValue('K262', $dt_raport['mapel']['5']['detail']['pengetahuan']['konversi']);
					$objPHPExcel->getActiveSheet()->setCellValue('M262', $dt_raport['mapel']['5']['detail']['keterampilan']['konversi']);
					$objPHPExcel->getActiveSheet()->setCellValue('O262', $dt_raport['mapel']['5']['detail']['sikap']['konversi']);
					$objPHPExcel->getActiveSheet()->setCellValue('C265', $dt_raport['mapel']['6']['NamaMapel']);
					$objPHPExcel->getActiveSheet()->setCellValue('E266', $dt_raport['mapel']['6']['NGuruMapel']);
					$objPHPExcel->getActiveSheet()->setCellValue('K265', $dt_raport['mapel']['6']['detail']['pengetahuan']['konversi']);
					$objPHPExcel->getActiveSheet()->setCellValue('M265', $dt_raport['mapel']['6']['detail']['keterampilan']['konversi']);
					$objPHPExcel->getActiveSheet()->setCellValue('O265', $dt_raport['mapel']['6']['detail']['sikap']['konversi']);
					$objPHPExcel->getActiveSheet()->setCellValue('C267', $dt_raport['mapel']['7']['NamaMapel']);
					$objPHPExcel->getActiveSheet()->setCellValue('E268', $dt_raport['mapel']['7']['NGuruMapel']);
					$objPHPExcel->getActiveSheet()->setCellValue('K267', $dt_raport['mapel']['7']['detail']['pengetahuan']['konversi']);
					$objPHPExcel->getActiveSheet()->setCellValue('M267', $dt_raport['mapel']['7']['detail']['keterampilan']['konversi']);
					$objPHPExcel->getActiveSheet()->setCellValue('O267', $dt_raport['mapel']['7']['detail']['sikap']['konversi']);
					$objPHPExcel->getActiveSheet()->setCellValue('C269', $dt_raport['mapel']['8']['NamaMapel']);
					$objPHPExcel->getActiveSheet()->setCellValue('E270', $dt_raport['mapel']['8']['NGuruMapel']);
					$objPHPExcel->getActiveSheet()->setCellValue('K269', $dt_raport['mapel']['8']['detail']['pengetahuan']['konversi']);
					$objPHPExcel->getActiveSheet()->setCellValue('M269', $dt_raport['mapel']['8']['detail']['keterampilan']['konversi']);
					$objPHPExcel->getActiveSheet()->setCellValue('O269', $dt_raport['mapel']['8']['detail']['sikap']['konversi']);
					$objPHPExcel->getActiveSheet()->setCellValue('C271', $dt_raport['mapel']['9']['NamaMapel']);
					$objPHPExcel->getActiveSheet()->setCellValue('E272', $dt_raport['mapel']['9']['NGuruMapel']);
					$objPHPExcel->getActiveSheet()->setCellValue('K271', $dt_raport['mapel']['9']['detail']['pengetahuan']['konversi']);
					$objPHPExcel->getActiveSheet()->setCellValue('M271', $dt_raport['mapel']['9']['detail']['keterampilan']['konversi']);
					$objPHPExcel->getActiveSheet()->setCellValue('O271', $dt_raport['mapel']['9']['detail']['sikap']['konversi']);
					$objPHPExcel->getActiveSheet()->setCellValue('C273', $dt_raport['mapel']['10']['NamaMapel']);
					$objPHPExcel->getActiveSheet()->setCellValue('E274', $dt_raport['mapel']['10']['NGuruMapel']);
					$objPHPExcel->getActiveSheet()->setCellValue('K273', $dt_raport['mapel']['10']['detail']['pengetahuan']['konversi']);
					$objPHPExcel->getActiveSheet()->setCellValue('M273', $dt_raport['mapel']['10']['detail']['keterampilan']['konversi']);
					$objPHPExcel->getActiveSheet()->setCellValue('O273', $dt_raport['mapel']['10']['detail']['sikap']['konversi']);
					$objPHPExcel->getActiveSheet()->setCellValue('C275', $dt_raport['mapel']['11']['NamaMapel']);
					$objPHPExcel->getActiveSheet()->setCellValue('E276', $dt_raport['mapel']['11']['NGuruMapel']);
					$objPHPExcel->getActiveSheet()->setCellValue('K275', $dt_raport['mapel']['11']['detail']['pengetahuan']['konversi']);
					$objPHPExcel->getActiveSheet()->setCellValue('M275', $dt_raport['mapel']['11']['detail']['keterampilan']['konversi']);
					$objPHPExcel->getActiveSheet()->setCellValue('O275', $dt_raport['mapel']['11']['detail']['sikap']['konversi']);
					$objPHPExcel->getActiveSheet()->setCellValue('C277', $dt_raport['mapel']['12']['NamaMapel']);
					$objPHPExcel->getActiveSheet()->setCellValue('E278', $dt_raport['mapel']['12']['NGuruMapel']);
					$objPHPExcel->getActiveSheet()->setCellValue('K277', $dt_raport['mapel']['12']['detail']['pengetahuan']['konversi']);
					$objPHPExcel->getActiveSheet()->setCellValue('M277', $dt_raport['mapel']['12']['detail']['keterampilan']['konversi']);
					$objPHPExcel->getActiveSheet()->setCellValue('O277', $dt_raport['mapel']['12']['detail']['sikap']['konversi']);
					$objPHPExcel->getActiveSheet()->setCellValue('C279', $dt_raport['mapel']['13']['NamaMapel']);
					$objPHPExcel->getActiveSheet()->setCellValue('E280', $dt_raport['mapel']['13']['NGuruMapel']);
					$objPHPExcel->getActiveSheet()->setCellValue('K279', $dt_raport['mapel']['13']['detail']['pengetahuan']['konversi']);
					$objPHPExcel->getActiveSheet()->setCellValue('M279', $dt_raport['mapel']['13']['detail']['keterampilan']['konversi']);
					$objPHPExcel->getActiveSheet()->setCellValue('O279', $dt_raport['mapel']['13']['detail']['sikap']['konversi']);

					$awal = 284;
					foreach($dt_raport['lintas'] as $kunci => $lintas)
					{
						$objPHPExcel->getActiveSheet()->setCellValue('C'.$awal, $dt_raport['lintas'][$kunci]['NamaMapel']);				
						$kedua = $awal + 1;
						$objPHPExcel->getActiveSheet()->setCellValue('E'.$kedua, $dt_raport['lintas'][$kunci]['NGuruMapel']);
						$objPHPExcel->getActiveSheet()->setCellValue('K'.$awal, $dt_raport['mapel'][$kunci]['detail']['pengetahuan']['konversi']);
						$objPHPExcel->getActiveSheet()->setCellValue('M'.$awal, $dt_raport['mapel'][$kunci]['detail']['keterampilan']['konversi']);
						$objPHPExcel->getActiveSheet()->setCellValue('O'.$awal, $dt_raport['mapel'][$kunci]['detail']['sikap']['konversi']);
						$awal += 2;
					}
				}
			}

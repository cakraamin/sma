...
<div id="content">
<div class="isi">
<form method="post" action="<?=base_url()?>mapel/submit_guru_kelas_mapel/<?=$kode?>" class="f-wrap-1" id="formMapelGuruKelass">
	<fieldset>		
	<h3>Form Data Guru Kelas Mata Pelajaran</h3>		
	<div class="konfirmasi"></div>
	<label for="jam"><b><span class="req"></span>Kelas :</b></label>
	<input name="page" type="hidden" class="f-name" id="page" value="<?=$kode?>"/>
	<?php
		$pk = 'id="kelas" class="kelas"';
		echo form_dropdown('kelas',$kelase,'',$pk);
	?>
	<br />

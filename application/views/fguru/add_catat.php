<div id="content">
<div class="isi">
<form method="post" action="<?=base_url()?>fguru/catatan/submit_catatan/<?=$kls?>/<?=$id?>" class="f-wrap-1" id="formCatat">
	<fieldset>		
	<h3>Form Tambah Catatan</h3>		
	<div class="konfirmasi"></div>
	<label for="catat"><b><span class="req"></span>Catatan :</b>
		<textarea name="catat" class="f-comments" rows="6" cols="40" id="catat"></textarea>
	</label><br/>

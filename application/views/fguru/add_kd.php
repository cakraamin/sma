...
$(document).ready( function() {		
	...
	$('#jumlah').change(function() {
		...
		for (i=1;i<=isi;i++)
		{
			var nilai = '<label for="judul'+ i +'"><b><span class="req"></span>Kompetensi Dasar :</b>'
...
<form method="post" action="<?=base_url()?>fguru/administrasi/submit_kd/<?=$id?>" class="f-wrap-1" id="formKompetensi">
	<fieldset>		
	<h3>Form Tambah Kompetensi Dasar</h3>		
	<div class="konfirmasi"></div>
	<label for="nama"><b><span class="req"></span>Satandar Kompetensi :</b></label>	
	<?
		if(count($sk) > 1)
		{
			$ps = 'id="sk" class="sk"';
			echo form_dropdown('sk',$sk,'',$ps);
		}
	?>	
	...
	?>
	<div id="inputs">
	<label for="judul1"><b><span class="req"></span>Kompetensi Dasar :</b>

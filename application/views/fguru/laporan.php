...
<div id="utility">
	<ul id="nav-secondary">
		...
		<li class="first"><a href="<?=base_url()?>fguru/laporan/wali/<?php echo $sWali; ?>" <?php if(isset($wali)){ echo $wali;}?>>Wali Kelas</a></li>		
	</ul>
</div>
<div id="content">
...
<form method="post" action="<?=base_url()?>fguru/laporan/submit_laporan">
	<label for="kunci"><b>Jenis Laporan :</b>
		<?php echo form_dropdown('jenis', $laporan); ?>
	</label><br/><br/>

...
<form method="post" action="<?=base_url()?>fguru/administrasi/submit_edit_indikator/<?=$id?>/<?=$kueri->id_administrasi?>" class="f-wrap-1" id="formKompetensi">
	<fieldset>		
	<h3>Form Edit Indikator</h3>		
	<div class="konfirmasi"></div>
	<label for="judul"><b><span class="req"></span>Indikator :</b>

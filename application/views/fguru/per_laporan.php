...
<div id="utility">
	<ul id="nav-secondary">
		<li class="first"><a href="<?=base_url()?>fguru/laporan" <? if(isset($tambah)){ echo $tambah;}?>>Semua</a></li>
		<li><a href="<?=base_url()?>fguru/laporan/per_anak" <? if(isset($daftar)){ echo $daftar;}?>>Per-anak</a></li>
	</ul>
</div>
<div id="content">
<div class="cari">
<form method="post" action="<?=base_url()?>fguru/laporan/submit_laporan">
	...
	<?
		...
		echo form_dropdown('anak',$anak,$ank,$pa);
	?>
	</label><br/><br/>	

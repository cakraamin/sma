...
<form method="post" action="<?=base_url()?>fguru/administrasi/submit_indikator/<?=$id?>" class="f-wrap-1" id="formKompetensi">
	<fieldset>		
	<h3>Form Tambah Indikator</h3>		
	<div class="konfirmasi"></div>
	<label for="nama"><b><span class="req"></span>Kompetensi Dasar :</b></label>	
	<?
		if(count($kd) > 1)
		{
			$pk = 'id="kd" class="kd"';
			echo form_dropdown('kd',$kd,'',$pk);
		}
	?>	
	...
	?>
	<div id="inputs">
	<label for="judul1"><b><span class="req"></span>Indikator :</b>

...
<form method="post" action="<?=base_url()?>kelas/submit_edit_kelas_wali/<?=$kueri->id_kelas_wali?>" class="f-wrap-1" id="formKelasWali">
	<fieldset>		
	<h3>Form Edit Data Wali</h3>		
	...
	<input name="nip" type="text" class="f-name" id="nip" value="<?=$kueri->nip?>"/><br />
	</label>-->
	<label for="nama"><b><span class="req"></span>Nama Guru :</b>
	<input name="nama" type="text" class="f-name" id="nama" value="<?=$kueri->nama?>"/>
	<input name="nip" type="hidden" class="f-name" id="nip" value="<?=$kueri->nip?>"/><br />
	</label>

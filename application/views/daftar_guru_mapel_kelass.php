...
<table width="100%" border="0" class="table1">
	...
	?>
	<tr <?=$klas?> id="tabel<?=$dt_kueri['kode']?>">
		<td><?=form_checkbox('cek[]', $dt_kueri['kode'])?></td><td><a href="<?=base_url()?>mapel/edit_guru_mapel_kelas/<?=$kode?>/<?=$dt_kueri['kode']?>/<?=$ref?>/<?=$sort_by?>/<?=$sort_order?>/<?=$page?>"><img src="<?=base_url()?>asset/images/edit.png"/></a></td><td><?php echo $dt_kueri['nama']; ?></td>
	</tr>
	<?php
		$no++;
		endforeach;
